...
public final class Constants {
  ...
  public enum RobotAlignPose {
    // Reefs
    BA(new Pose2d(3.1029999999999998, 3.9949999999999997, Rotation2d.fromDegrees(0)), true),
    RA(new Pose2d(14.447000000000001, 4.061, Rotation2d.fromDegrees(180)), true),
    BB(new Pose2d(3.1029999999999998, 3.655, Rotation2d.fromDegrees(0)), true),
    RB(new Pose2d(14.447000000000001, 4.401, Rotation2d.fromDegrees(180)), true),
    BC(new Pose2d(3.8245788383248867, 2.8111887903547674, Rotation2d.fromDegrees(60)), true),
    RC(new Pose2d(13.725421161675115, 5.244811209645231, Rotation2d.fromDegrees(-120)), true),
    BD(new Pose2d(4.119027475611595, 2.6411887903547675, Rotation2d.fromDegrees(60)), true),
    RD(new Pose2d(13.430972524388405, 5.414811209645231, Rotation2d.fromDegrees(-120)), true),
    BE(new Pose2d(5.210578838324886, 2.844188790354768, Rotation2d.fromDegrees(120)), true),
    RE(new Pose2d(12.339421161675116, 5.211811209645232, Rotation2d.fromDegrees(-60)), true),
    BF(new Pose2d(5.5050274756115956, 3.0141887903547677, Rotation2d.fromDegrees(120)), true),
    RF(new Pose2d(12.044972524388406, 5.041811209645232, Rotation2d.fromDegrees(-60)), true),
    BG(new Pose2d(5.875, 4.061, Rotation2d.fromDegrees(180)), true),
    RG(new Pose2d(11.675, 3.994999999999999, Rotation2d.fromDegrees(0)), true),
    BH(new Pose2d(5.875, 4.401, Rotation2d.fromDegrees(180)), true),
    RH(new Pose2d(11.675, 3.6549999999999994, Rotation2d.fromDegrees(0)), true),
    BI(new Pose2d(5.153421161675113, 5.244811209645231, Rotation2d.fromDegrees(-120)), true),
    RI(new Pose2d(12.396578838324888, 2.811188790354768, Rotation2d.fromDegrees(60)), true),
    BJ(new Pose2d(4.858972524388403, 5.414811209645231, Rotation2d.fromDegrees(-120)), true),
    RJ(new Pose2d(12.691027475611598, 2.641188790354768, Rotation2d.fromDegrees(60)), true),
    BK(new Pose2d(3.767421161675113, 5.211811209645232, Rotation2d.fromDegrees(-60)), true),
    RK(new Pose2d(13.782578838324888, 2.8441887903547673, Rotation2d.fromDegrees(120)), true),
    BL(new Pose2d(3.472972524388404, 5.041811209645232, Rotation2d.fromDegrees(-60)), true),
    RL(new Pose2d(14.077027475611597, 3.0141887903547673, Rotation2d.fromDegrees(120)), true),
    // Processors
