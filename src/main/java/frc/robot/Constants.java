...
public final class Constants {
  ...
  public enum RobotAlignPose {
    // Reefs
    BA(new Pose2d(3.2093371, 3.9981723000000002, Rotation2d.fromDegrees(0)), true),
    RA(new Pose2d(14.338913300000002, 4.0537293000000005, Rotation2d.fromDegrees(180)), true),
    BB(new Pose2d(3.2093371, 3.6695533000000005, Rotation2d.fromDegrees(0)), true),
    RB(new Pose2d(14.338913300000002, 4.3823483, Rotation2d.fromDegrees(180)), true),
    BC(new Pose2d(3.873393986679026, 2.903549033155919, Rotation2d.fromDegrees(60)), true),
    RC(new Pose2d(13.674856413320974, 5.148352566844082, Rotation2d.fromDegrees(-120)), true),
    BD(new Pose2d(4.157986388845265, 2.739239533155919, Rotation2d.fromDegrees(60)), true),
    RD(new Pose2d(13.390264011154736, 5.312662066844082, Rotation2d.fromDegrees(-120)), true),
    BE(new Pose2d(5.153393986679026, 2.931327533155919, Rotation2d.fromDegrees(120)), true),
    RE(new Pose2d(12.394856413320975, 5.120574066844082, Rotation2d.fromDegrees(-60)), true),
    BF(new Pose2d(5.437986388845264, 3.095637033155919, Rotation2d.fromDegrees(120)), true),
    RF(new Pose2d(12.110264011154737, 4.956264566844082, Rotation2d.fromDegrees(-60)), true),
    BG(new Pose2d(5.7693371, 4.0537293000000005, Rotation2d.fromDegrees(180)), true),
    RG(new Pose2d(11.7789133, 3.9981723000000002, Rotation2d.fromDegrees(0)), true),
    BH(new Pose2d(5.7693371, 4.3823483, Rotation2d.fromDegrees(180)), true),
    RH(new Pose2d(11.7789133, 3.6695533000000005, Rotation2d.fromDegrees(0)), true),
    BI(new Pose2d(5.105280213320974, 5.148352566844082, Rotation2d.fromDegrees(-120)), true),
    RI(new Pose2d(12.442970186679027, 2.903549033155919, Rotation2d.fromDegrees(60)), true),
    BJ(new Pose2d(4.820687811154736, 5.312662066844082, Rotation2d.fromDegrees(-120)), true),
    RJ(new Pose2d(12.727562588845265, 2.739239533155919, Rotation2d.fromDegrees(60)), true),
    BK(new Pose2d(3.825280213320974, 5.120574066844082, Rotation2d.fromDegrees(-60)), true),
    RK(new Pose2d(13.722970186679026, 2.931327533155919, Rotation2d.fromDegrees(120)), true),
    BL(new Pose2d(3.540687811154736, 4.956264566844082, Rotation2d.fromDegrees(-60)), true),
    RL(new Pose2d(14.007562588845264, 3.095637033155919, Rotation2d.fromDegrees(120)), true),
    // Processors
