...
public final class Constants {
  ...
  public enum RobotAlignPose {
    // Reefs
    BA(new Pose2d(3.2193371, 4.055950800000001, Rotation2d.fromDegrees(0)), true),
    RA(new Pose2d(14.3289133, 3.9959508, Rotation2d.fromDegrees(180)), true),
    BB(new Pose2d(3.2193371, 3.7159508000000003, Rotation2d.fromDegrees(0)), true),
    RB(new Pose2d(14.3289133, 4.335950800000001, Rotation2d.fromDegrees(180)), true),
    BC(new Pose2d(3.828356337886467, 2.9410985371937635, Rotation2d.fromDegrees(60)), true),
    RC(new Pose2d(13.719894062113534, 5.110803062806237, Rotation2d.fromDegrees(-120)), true),
    BD(new Pose2d(4.1228049751731755, 2.7710985371937635, Rotation2d.fromDegrees(60)), true),
    RD(new Pose2d(13.425445424826826, 5.280803062806237, Rotation2d.fromDegrees(-120)), true),
    BE(new Pose2d(5.098356337886466, 2.9110985371937628, Rotation2d.fromDegrees(120)), true),
    RE(new Pose2d(12.449894062113534, 5.140803062806238, Rotation2d.fromDegrees(-60)), true),
    BF(new Pose2d(5.392804975173176, 3.0810985371937627, Rotation2d.fromDegrees(120)), true),
    RF(new Pose2d(12.155445424826825, 4.9708030628062385, Rotation2d.fromDegrees(-60)), true),
    BG(new Pose2d(5.7593371, 3.9959508000000006, Rotation2d.fromDegrees(180)), true),
    RG(new Pose2d(11.7889133, 4.0559508, Rotation2d.fromDegrees(0)), true),
    BH(new Pose2d(5.7593371, 4.3359508, Rotation2d.fromDegrees(180)), true),
    RH(new Pose2d(11.7889133, 3.7159508000000008, Rotation2d.fromDegrees(0)), true),
    BI(new Pose2d(5.150317862113534, 5.110803062806238, Rotation2d.fromDegrees(-120)), true),
    RI(new Pose2d(12.397932537886467, 2.9410985371937626, Rotation2d.fromDegrees(60)), true),
    BJ(new Pose2d(4.855869224826824, 5.280803062806238, Rotation2d.fromDegrees(-120)), true),
    RJ(new Pose2d(12.692381175173177, 2.7710985371937626, Rotation2d.fromDegrees(60)), true),
    BK(new Pose2d(3.880317862113533, 5.1408030628062376, Rotation2d.fromDegrees(-60)), true),
    RK(new Pose2d(13.667932537886468, 2.911098537193763, Rotation2d.fromDegrees(120)), true),
    BL(new Pose2d(3.585869224826824, 4.970803062806238, Rotation2d.fromDegrees(-60)), true),
    RL(new Pose2d(13.962381175173176, 3.081098537193763, Rotation2d.fromDegrees(120)), true),
    // Processors
