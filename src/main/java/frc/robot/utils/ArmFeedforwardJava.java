 ...
 */
public class ArmFeedforwardJava implements ProtobufSerializable, StructSerializable {
   ...
   */
  public ArmFeedforwardJava(double ks, double kg, double kv, double ka, double dtSeconds) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
   ...
   * @throws IllegalArgumentException for ka &lt; zero.
   */
  public ArmFeedforwardJava(double ks, double kg, double kv, double ka) {
   ...
   * @throws IllegalArgumentException for kv &lt; zero.
   */
  public ArmFeedforwardJava(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
