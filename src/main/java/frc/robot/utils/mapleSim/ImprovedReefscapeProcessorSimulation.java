 ...
 *
 * <p>This class simulates a <strong>PROCESSOR</strong>s on the field where <strong>ALGAE</strong>s
...
public class ImprovedReefscapeProcessorSimulation extends Goal {
     ...
     */
    public ImprovedReefscapeProcessorSimulation(ImprovedArena2025Reefscape arena, boolean isBlue) {
        super(
                arena,
                Centimeters.of(100),
                Centimeters.of(100),
