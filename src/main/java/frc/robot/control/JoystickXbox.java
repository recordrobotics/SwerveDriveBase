...
public class JoystickXbox extends AbstractControl {
  ...
  public Boolean getAcquire() {
    return xbox_controller.getLeftTriggerAxis() > 0.3
        || joystick.getRawButton(3); // aka the left trigger axis
  }

  @Override
  public Boolean getReverse() {
    return xbox_controller.getLeftBumper()
        || joystick.getRawButton(5); // aka the left trigger button
  }

  @Override
  public Boolean getShootSpeaker() {
    return xbox_controller.getRightTriggerAxis() > 0.3
        || joystick.getRawButton(4); // aka the right trigger axis
  }

  @Override
  public Boolean getShootAmp() {
    return xbox_controller.getRightBumper()
        || joystick.getRawButton(6); // aka the right trigger button
  }
